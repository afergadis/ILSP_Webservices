 ...
 * generated in the gr.ilsp.nlp.webservices.ilsp_chunker package.
...
public class ObjectFactory {
    ...
    private final static QName _GetSomeResultsResponse_QNAME = new QName("http://soaplab.org/ilsp_chunker", "getSomeResultsResponse");
    ...
    private final static QName _RunAndWaitForResponse_QNAME = new QName("http://soaplab.org/ilsp_chunker", "runAndWaitForResponse");
    private final static QName _RunAndWaitFor_QNAME = new QName("http://soaplab.org/ilsp_chunker", "runAndWaitFor");
    ...
    private final static QName _GetResultsResponse_QNAME = new QName("http://soaplab.org/ilsp_chunker", "getResultsResponse");
    private final static QName _GetLastEventResponse_QNAME = new QName("http://soaplab.org/typedws", "getLastEventResponse");
    private final static QName _Run_QNAME = new QName("http://soaplab.org/ilsp_chunker", "run");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: gr.ilsp.nlp.webservices.ilsp_chunker
     */
     ...
     */
    @XmlElementDecl(namespace = "http://soaplab.org/ilsp_chunker", name = "getSomeResultsResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://soaplab.org/ilsp_chunker", name = "runAndWaitForResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://soaplab.org/ilsp_chunker", name = "runAndWaitFor")
     ...
     * Create an instance of {@link JAXBElement }{@code <}{@link AppResults }{@code >}}
     */
    @XmlElementDecl(namespace = "http://soaplab.org/ilsp_chunker", name = "getResultsResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://soaplab.org/ilsp_chunker", name = "run")
